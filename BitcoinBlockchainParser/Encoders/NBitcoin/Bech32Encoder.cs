...
internal class Bech32Encoder : DataEncoder
{
  ...
  626, 978, 825, 344, 605, 654, 209
    ...
    protected static readonly byte[] Byteset = Encoders.ASCII.DecodeData("qpzry9x8gf2tvdw0s3jn54khce6mua7l");
    ...
    protected static uint Polymod(byte[] values)
    {
        uint chk = 1;
    ...
    protected virtual byte[] CreateChecksum(byte[] data, int offset, int count)
    {
